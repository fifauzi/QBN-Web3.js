  ...
  return (
    <ul className="list-group">
      <li clasName="list-group-item">
        ...
        <button type="button" className="btn btn-primary float-right" onClick={() => buy(ITEMS[0])}>
          buy
        </button>
      </li>
      ...
      <li clasName="list-group-item">
        ...
        <button type="button" className="btn btn-primary float0-right" onClick={() => buy(ITEMS[1])}>
          buy
        </button>
      </li>
    </ul>
